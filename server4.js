...
// // Validation method to check if a string contains only alphabets, whitespaces, and periods
// const isStringOnly = (str) => {
//     return /^[A-Za-z\s.]+$/.test(str);
// };

// Validation method to check if a string is enclosed in double quotes and contains only alphabets, whitespaces, periods, underscores, and numeric characters
const isStringOnly = (str) => {
...
//     return validStatuses.includes(status.toLowerCase().replace(/\s/g, '_'));
// };
